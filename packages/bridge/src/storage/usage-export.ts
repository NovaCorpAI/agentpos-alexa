...
const FIELD_BY_COLUMN: Record<(typeof USAGE_EVENTS_CSV_COLUMNS)[number], (e: UsageEvent) => unknown> = {
  ...
  cache_read_tokens: (e) => e.cacheReadTokens ?? 0,
  cache_write_tokens: (e) => e.cacheWriteTokens ?? 0,
  ...
  return rows
    ...
    .map((r) => {
      const e: UsageEvent = {
        ...
        cacheReadTokens: Number(at(r, "cache_read_tokens") || 0),
        cacheWriteTokens: Number(at(r, "cache_write_tokens") || 0),
